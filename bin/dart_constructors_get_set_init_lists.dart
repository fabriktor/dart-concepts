...
void main(List<String> arguments) {
  ...
  //initialize a truck
  print(Truck(brand: 'Chevy', model: 'Silverado', milesPerGallon: 18).stringTruck());

  //is the truck fuel efficient?
  var truck = Truck(brand: 'Chevy', model: 'Silverado', milesPerGallon: 18);
  print('${truck.stringTruck()} and is it fuel efficient?: ${truck.isEconomic.toString()}');

  //initiate a fuel efficient truck and use getter to return true or false about fuel efficiency
  var efficientTruck = Truck(brand: 'Ford', model: 'Maverick', milesPerGallon: 12);
  print('${efficientTruck.stringTruck()} and is it fuel efficient?: ${efficientTruck.isEconomic.toString()}');
...
class Car{
  ...
  Car.named({required this.model, required this.brand});
...
class Truck{
  ...
  Truck({required String model, required String brand, required int milesPerGallon}) :
